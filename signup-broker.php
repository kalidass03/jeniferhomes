            ...
            <div id="page-content">
                ...
                <div class="container">
                    <header class="thetitles">
                        <h1>Broker Sign Up</h1>
                    </header>
                    <div class="row">
                        <div class="col-md-8 col-sm-12 col-md-offset-2">
                            <?php if (isset($_SESSION['BROKER_REGISTRATION_MSG']))
                            { ?>
                                <div class="alert alert-success">
                                    <strong></strong><?php echo $_SESSION['BROKER_REGISTRATION_MSG']; ?>
                                </div>
                                <?php unset($_SESSION['BROKER_REGISTRATION_MSG']); ?>
<?php } else
{

} ?>
                            <form role="form" id="form-create-agency" method="post" action="broker_actions.php">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <section id="address">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        <label for="form-create-agency-zip">License Number:</label>
                                ...
                                <section id="submit">
                                    <div class="form-group center">
                                        <input type="hidden" name="action" value="broker_registration" id="broker_registration"/>
