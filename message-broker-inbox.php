...
WHERE broker_id='".$_SESSION['SESS_USER_ID']."' AND user_name_last_message!='".$_SESSION['SESS_USER_NAME']."'";
//exit;
        	...
        	<div class="col-md-10 col-md-offset-1">
                ...
                <div class="col-sm-12 col-md-8"> 
                    ...
                    <table class="table table-striped table-hover">
                         <?php  $single_c_data =get_table_data('conversations', 'broker_id='.$_SESSION['SESS_USER_ID'].'', false, false); 
					   ...
					   <?php foreach($single_c_data as $data) {
						   ...
						   $single_p_data =get_table_data('property', 'property_id='.$data->property_id.'', false, false); ?>
                        <tr class="doc_id" id="<?php echo $_SESSION['SESS_USER_ID']."_".$data->property_id."_".$single_p_data[0]->user_id;?>">
                ...
                <a href="broker-dashboard.php" class="link-arrow">Go to Dashboard</a>
            </section>
