...
<?php } ?>
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <form action="broker_actions.php" method="post" id="form-create-agency" role="form">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                <label for="form-create-agency-address-2">License Number:</label>
                                                                <input type="text" required="" name="license_number" id="license_number" class="form-control" value="<?php echo $current_user->license_number; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <section id="submit">
                                                    <div class="form-group center">
                                                        ...
                                                        <input type="hidden" id="edit_broker_profile" value="edit_broker_profile" name="action">
